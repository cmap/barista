...
<html>
  <head>
    ...
    <link rel="stylesheet" href="./doxx_template.css"><link href='http://fonts.googleapis.com/css?family=Roboto+Slab|Open+Sans' rel='stylesheet' type='text/css'>
  ...
  <body data-spy="scroll" data-target=".scrollspy">
    ...
    <header id="overview" class="jumbotron"><img src="http://coreyflynn.github.io/Bellhop/img/cmap_broad_logo_small.png">
      <div class="container">
        <h1>barista</h1>
        <p class="lead"></p>
      </div>
      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul style="font-family: Open Sans" class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li><a onclick="listCollapse(this)" class="lower_outer">Collections
            ...
            <li><a onclick="listCollapse(this)" class="lower_outer">Datasets
                <ul style="display: none;list-style-type: none">
            ...
            <li><a onclick="listCollapse(this)" class="lower_outer">Models
                <ul style="display: none;list-style-type: none">
            ...
            <li><a onclick="listCollapse(this)" class="lower_outer">Utils
                <ul style="display: none;list-style-type: none">
            ...
            <li><a onclick="listCollapse(this)" class="lower_outer">Views
                <ul style="display: none;list-style-type: none">
