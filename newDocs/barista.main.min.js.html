      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li><a onclick="listCollapse(this)" class="lower_outer">Collections &darr;
            ...
            <li><a onclick="listCollapse(this)" class="lower_outer">Datasets &darr;
                <ul style="display: none">
            ...
            <li><a onclick="listCollapse(this)" class="lower_outer">Models &darr;
                <ul style="display: none">
            ...
            <li><a onclick="listCollapse(this)" class="lower_outer">Utils &darr;
                <ul style="display: none">
            ...
            <li><a onclick="listCollapse(this)" class="lower_outer">Views &darr;
                <ul style="display: none">
